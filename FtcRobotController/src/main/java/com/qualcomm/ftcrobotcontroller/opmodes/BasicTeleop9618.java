...
so, as far as i can tell the only issue we have now is that android studio won't generate an APK. it keeps saying it's building the project but there's never an apk folder... ???
